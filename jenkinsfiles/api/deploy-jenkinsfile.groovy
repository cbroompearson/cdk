pipeline {
    ...
    environment { 
        ...
        SERVICE = "ocu-${params.ENV}-api"
        TASK_DEF = "ocu-${params.ENV}-api"
        FAMILY = "ocu-${params.ENV}-api"
    }
    stages {
        ...
        stage('Update App Task') {
            steps {
                echo 'Updating Task..'
                sh """
                    sed -i "s/<<IMAGEID>>/${params.IMAGE_TAG}/g" task-defs/api/taskdef-${params.ENV}.json
